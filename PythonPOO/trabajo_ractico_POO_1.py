...
while True: 
    ...
    valor = input("Ingresa el valor que deseas : ")
    if valor == "FIN" :
        break  
    fila = input("Ingresa la fila en que deseas agregar el valor : ")           
    columna = input("Ingresa la columna en que deseas agregar el valor : ")           
